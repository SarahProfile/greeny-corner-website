          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="mt-4 sm:mt-0 flex gap-3">
              <button
                ...
                className="inline-flex items-center px-4 py-3 border-2 border-emerald-600 text-base font-medium rounded-xl text-emerald-600 bg-white hover:bg-emerald-50 shadow-md hover:shadow-lg transform hover:scale-105 transition-all duration-200"
              ...
              <Link
                href="/add-plant"
                className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-xl text-white bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200"
              >
